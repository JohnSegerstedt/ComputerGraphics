...
GLuint		positionBuffer, positionBuffer2, colorBuffer, indexBuffer, indexBuffer2, vertexArrayObject, vertexArrayObject2, texture, texture2;
...
void initGL()
{
	...
	const float positions2[] = {
		// X Y Z
		10.0f, 10.0f, -40.0f,   // v0
		-10.0f, 10.0f, -40.0f,   // v1
		10.0f, -10.0f, -40.0f,   // v2
		-10.0f, -10.0f, -40.0f    // v3
	};
	...
	int w2, h2, comp2;
	unsigned char* image2 = stbi_load("../lab2-textures/explosion.png", &w2, &h2, &comp2, STBI_rgb_alpha);
